...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            int batteryStatus = batteryStatusIntent.getIntExtra(BatteryManager.EXTRA_STATUS, 0);
        ...
        // DONE (4) If your user is not on M+, then...
            ...
            // DONE (6) Set a new Intent object equal to what is returned by registerReceiver,
            // passing in null
