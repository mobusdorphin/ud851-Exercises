...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 2394;
    private static final int ACTION_DRINK_PENDING_INTENT_ID = 2395;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context,WATER_REMINDER_NOTIFICATION_CHANNEL_ID)
                ...
                .addAction(drinkiWaterAction(context))
    ...
    public static NotificationCompat.Action drinkiWaterAction(Context context) {
