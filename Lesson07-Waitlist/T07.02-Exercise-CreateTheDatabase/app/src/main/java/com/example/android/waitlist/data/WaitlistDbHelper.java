...
public class WaitlistDbHelper extends SQLiteOpenHelper {
    ...
    // DONE (6) Inside, create an String query called SQL_CREATE_WAITLIST_TABLE that will create
    // the table

        // DONE (7) Execute the query by calling execSQL on sqLiteDatabase and pass the string
