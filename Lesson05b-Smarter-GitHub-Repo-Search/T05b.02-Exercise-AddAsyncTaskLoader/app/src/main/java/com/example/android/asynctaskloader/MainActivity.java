...
public class MainActivity extends AppCompatActivity
    ...
    private static final String TAG = "MainActivitay";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // DONE (24) Initialize the loader with GITHUB_SEARCH_LOADER as the ID, null for the bundle,
    ...
    private void makeGithubSearchQuery() {
        ...
        // DONE (17) If no search was entered, indicate that there isn't anything to
        ...
        // DONE (20) Use putString with SEARCH_QUERY_URL_EXTRA as the key and the
        // String value of the URL as the value
        ...
        Loader<Object> gitHubSearchLoader = loaderManager
                .getLoader(GITHUB_SEARCH_LOADER);
    ...
    // Within onCreateLoader
        // DONE (4) Return a new AsyncTaskLoader<String> as an anonymous inner class
        // with this as the constructor's parameter
            ...
            // DONE (9) Override loadInBackground
                ...
                // DONE (10) Get the String for our URL from the bundle passed
                // to onCreateLoader

                // DONE (11) If the URL is null or empty, return null

                // DONE (12) Copy the try / catch block from the AsyncTask's
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                Log.d(TAG, "loadInBackground: Reached loadInBackground()");
                String URLstring = args.getString(SEARCH_QUERY_URL_EXTRA);
                if ((URLstring == null) || TextUtils.isEmpty(URLstring)) {
                    Log.d(TAG, "loadInBackground: No URLString found!");
                    return null;
                }

                try {
                    Log.d(TAG, "loadInBackground: Reached Try Block");
    ...
    // DONE (13) Override onLoadFinished
        ...
        // DONE (15) Use the same logic used in onPostExecute to show the data or
        // the error message
        // END - onLoadFinished
    @Override
