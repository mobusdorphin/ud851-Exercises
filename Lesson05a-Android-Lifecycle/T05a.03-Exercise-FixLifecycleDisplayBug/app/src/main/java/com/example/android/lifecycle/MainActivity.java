...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // DONE (4) Iterate backwards through mLifecycleCallbacks,
        // appending each String and a newline to mLifecycleDisplay
        ListIterator<String> listIterator = mLifecycleCallbacks.listIterator();
        while (listIterator.hasNext()) {
            listIterator.next();
        }
        while (listIterator.hasPrevious()) {
            String state = listIterator.previous();
            Log.d("Iterator:", state);
            logAndAppend(state);
        }
